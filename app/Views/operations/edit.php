...
$pageTitle = 'Editar - ' . ($op['title'] ?? 'Detalhes');
...
<section class="ops-hero ops-hero--clean">
    <div class="container">
        <div class="ops-hero__stack d-flex justify-content-between align-items-start">
            <div>
                <h1 class="ops-hero__title">Editar Operação</h1>
                <p class="ops-hero__subtitle">Atualize os dados da operação e defina os responsáveis por cada etapa</p>
            </div>
            <a href="/operations/<?= (int)$op['id'] ?>" class="btn btn-brand d-inline-flex align-items-center gap-2 mb-3">
...
<div class="container my-4">
    <form method="post" action="/operations/<?= (int)$op['id'] ?>">
        ...
        <div class="col-12">
            <div class="card shadow-sm ops-card">
                <div class="card-header ops-card__header">
                    ...
                    <div class="ms-auto small opacity-75">Campos obrigatórios marcados com *</div>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="title" class="form-control ops-input" value="<?= $val('title') ?>" required>
                        </div>
                        <div class="col-md-3">
        ...
        <div class="col-12 d-flex gap-2 justify-content-end">
            <a class="btn btn-brand" href="/operations/<?= (int)$op['id'] ?>">Cancelar</a>
